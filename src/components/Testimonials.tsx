...
// Arah masuk berbeda untuk tiap card
const CARD_ORIGINS = [
  { x: -60, y: 40 },
  { x: 0, y: 80 },
  { x: 60, y: 40 },
  ...
  return (
    <section id="testimonials" className="bg-[#FAF9F6] py-32 overflow-hidden">
      <div className="container">
        ...
        {/* Cards — muncul dari arah berbeda */}
            ...
            <div
              ...
              style={{
                ...
                transform: cardsVisible
                  ? "translate(0, 0)"
                  : `translate(${CARD_ORIGINS[idx].x}px, ${CARD_ORIGINS[idx].y}px)`,
                transition: `opacity 0.7s ease ${idx * 0.15}s, transform 0.8s cubic-bezier(0.16,1,0.3,1) ${idx * 0.15}s`,
              }}
            >
              {/* Stars */}
              <div
                ...
                style={{
                  opacity: cardsVisible ? 1 : 0,
                  transition: `opacity 0.5s ease ${0.3 + idx * 0.15}s`,
                }}
              >
                {[...Array(5)].map((_, i) => (
